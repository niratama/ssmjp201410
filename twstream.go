...
var (
	...
	timeoutString     = flag.String("timeout", "0", "Connection timeout")
	query             = flag.String("query", "", "Query string")
)
var timeout time.Duration
var ps *pubsub.PubSub

func twitterSearch(query string) {
...
func twitterSearchHandler(ws *websocket.Conn) {
	...
	*/
	...
	ps.Sub(func(tweet *twitterstream.Tweet) {
